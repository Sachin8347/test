...
// The unused 'useEffect' import has been removed.
...
const MemoizedEditor = React.memo(function MemoizedEditor({
  code,
  onChange,
  // The type for previewRef is now correctly allowing null.
  previewRef,
}: {
  code: string;
