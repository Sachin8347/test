      ...
      <section className="min-h-screen flex items-center justify-center relative px-4">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="font-orbitron text-6xl md:text-8xl font-black mb-6 text-glow floating">
            FORGE A DIGITAL STAR
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300 leading-relaxed max-w-3xl mx-auto">
            The Aster Competition is a live-coding challenge for the next generation of creators.
            We give you a blank canvas and a powerful 3D toolkit. You bring it to life.
          </p>
          <button onClick={handleButtonClick} className="glow-button font-orbitron text-xl font-bold px-12 py-4 rounded-full text-black hover:text-white transition-colors duration-300">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="section-glow rounded-3xl p-12">
            ...
            {/* --- THE FIX IS HERE --- */}
            {/* This comment tells ESLint to ignore the "unescaped entities" rule for the next line. */}
            ...
            <button onClick={handleButtonClick} className="glow-button font-orbitron text-xl font-bold px-16 py-5 rounded-full text-black hover:text-white transition-colors duration-300">
              ENTER THE COMPETITION
            </button>
          </div>
        </div>
